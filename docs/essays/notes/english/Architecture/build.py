# build.py
# Build an internal bundle for the Architecture series.
# Put this file in:
...
OUTPUT_FILE = BASE_DIR / "_architecture-bundle.md"

SERIES_TITLE = "The Architecture of Production and Capture｜Internal Bundle"
