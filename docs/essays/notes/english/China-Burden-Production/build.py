# build.py
# Build an internal bundle for the China and the Burden of Production series.
# Put this file in:
...
OUTPUT_FILE = BASE_DIR / "_china-burden-production-bundle.md"

SERIES_TITLE = "China and the Burden of Production｜Internal Bundle"
