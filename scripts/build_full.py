...
def main():
    ...
    build_full(
        ...
        files=[
            "00-c-reading-before.md",
            "01-c-three-patterns-civilization.md",
            "02-c-china-sys-work-not-consume.md",
            "03-c-global-south-not-second-china.md",
            "04-c-china-unique-way-not-world-answer.md",
            "05-c-mature-markets-reject-china-industry2.md",
            "06-c-prod-free-circulation-restricted.md",
            "07-c-hotwar-not-opt-solution.md",
            "08-c-overseas-invest-closed-loop.md",
            "09-c-production-consumption-lifecycle.md",
...
Reality｜现实世界 用于说明旧世界为什么走到边界。""",
    ...
    build_full(
        ...
        files=[
            ...
            "05-c-mature-markets-reject-china-industry2.md",
            "06-c-prod-free-circulation-restricted.md",
            "07-c-real-marketwar-target-monetize-not-factories.md",
            "08-c-post-pax-americana-order.md",
